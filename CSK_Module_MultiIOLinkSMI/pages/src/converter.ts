...
export function changeStyle(theme) {
  ...
  if (theme == 'CSK_Style'){
    ...
    var customBackground =  `.CSK_Module_MultiIOLinkSMI .myCustomBackground_CSK_Module_MultiIOLinkSMI { background-color: #737F8522; }` // font-family: "Open Sans"; }`
    ...
    var customBackground =  `.CSK_Module_MultiIOLinkSMI .myCustomBackground_CSK_Module_MultiIOLinkSMI { background-color: #fff; }` // font-family: "sans-serif"; }`
